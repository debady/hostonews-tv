<?php 
    session_start();
    $titre_appli ="Inscription par Numéro de téléphone " ;
                        ...
                        <div class="col-lg-8 mx-auto col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                    <form role="form" method="post" action="numero/trait_inscript_number.php">

                                        <div class="form-floating">
                                            <input type="text" name="numero" id="numero" class="form-control" value="+225" required>
                                        ...
                                        <p class="text-center">Préfère ? <a href="inscription.php">Email</a></p>
